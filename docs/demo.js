...
(() => {
  ...
  const viz = new GloamingKit({
    ...
    timeline: [
      ...
      { from: 38, to: 51, visualizations: [VIZ.AIZAWA, VIZ.PARTICLES, VIZ.ROSSLER], style: { background: '#1800f5', lineColor: '#ffae00' } },
      { from: 51, to: 64, visualizations: [VIZ.ROAD, VIZ.TUNNEL] },
      { from: 64, to: 77, visualizations: [VIZ.ATTRACTOR, VIZ.PARTICLES] },
